...
<html lang="en">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="namamatakuliah" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Jumlah SKS</label>
    <input type="number" name="jumlahsks" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Dosen Pengampu</label>
    <input type="text" name="dosenpengampu" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
